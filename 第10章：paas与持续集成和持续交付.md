...
Jenkins是一个持续集成和持续部署过程中非常有代表性的工具，它可以将上述流程串接为Pipepline的形式，既方便修改流程，也能实现非常好的可视化。有了Docker之后，代码的交付变得更加简单，因此也降低了持续集成和持续交付的实施难度。体现在如下几个变化：
