...
* 应用市场。PaaS平台中除了托管应用开发者自己开发的个性化应用之外，还需要能运行和定制化其他开发者开发的应用，这些应用就在应用市场中共其他人选用。它们或者是以代码的形式在其中运行，或者是一些开发的API。应用市场有助于扩展PaaS云服务提供商自身的生态，不但能引入除了其自身提供的后端支持服务的其他外部组件，还可以帮助云平台中的开发者获取自己的收入。
