...
还有一些公司围绕IaaS的生态链，在IaaS平台上推出自己的PaaS管理方案，让企业可以在公有的IaaS之上（例如AWS和阿里云之类的）搭建自己的私有PaaS平台，这种方案现在被称为**专有云**（Dedicated Cloud）。专有云的方案结合了IaaS对于基础资源方面的优化以及PaaS面向开发者提供的便利，又避免了PaaS隔离程度不够可能引起的安全或资源争抢的问题，是一种比较好的支持企业应用上云的方案。Docker收购了Tutum之后，已经联合Azure和阿里云，推出了自己的私有PaaS管理平台方案。
